  ...
  return (
    <>
      <div className="w-[270px] rounded-s-lg  ">
        <aside className=" ">
          <div className="px-3 py-4 h-[100vh] bg-slate-700 ml-2 rounded-xl overflow-x-auto ">
            ...
            <div className="flex flex-col  h-full">
              <ul className="space-y-2 font-medium ">
                ...
                <div>
                  {" "}
                  <hr className="border-t border-gray-300  hover:bg-slate-400  hover:rounded-xl  mb-3 " />
                </div>
                <span className="ml-2 whitespace-nowrap text-white text-bold   ">
                  DOCS
                </span>
                <div className="flex  p-2 text-white hover:bg-slate-400  hover:rounded-xl   ">
                  <div className="flex justify-start p-1 ">
